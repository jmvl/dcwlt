...
async function openBrowserAsync(url) {
  ...
  try {
    result = await _NativeWebBrowser.default.openBrowserAsync(url, _processOptions(browserParams));
  } finally {
...
async function openAuthSessionAsync(url, redirectUrl) {
  ...
  if (_authSessionIsNativelySupported()) {
    ...
    if (['ios', 'web'].includes(_reactNative.Platform.OS)) {
      return _NativeWebBrowser.default.openAuthSessionAsync(url, redirectUrl, _processOptions(options));
    }

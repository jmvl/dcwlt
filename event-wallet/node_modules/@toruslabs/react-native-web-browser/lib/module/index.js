...
export async function openBrowserAsync(url) {
  ...
  try {
    result = await NativeWebBrowser.openBrowserAsync(url, _processOptions(browserParams));
  } finally {
...
export async function openAuthSessionAsync(url, redirectUrl) {
  ...
  if (_authSessionIsNativelySupported()) {
    ...
    if (['ios', 'web'].includes(Platform.OS)) {
      return NativeWebBrowser.openAuthSessionAsync(url, redirectUrl, _processOptions(options));
    }
